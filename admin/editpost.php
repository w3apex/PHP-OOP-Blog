                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <form action="" method="POST" class="form-horizontal" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="tags" id="tags" value="<?php echo $result['tags'];?>">
                                        </div>
                                    </div>
                            ...
                            <?php
                                if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                                    ...
                                    if (!empty($_POST['cat']) && !empty($_POST['title']) && !empty($_POST['content']) && !empty($_POST['tags']) && !empty($_POST['author'])) {
